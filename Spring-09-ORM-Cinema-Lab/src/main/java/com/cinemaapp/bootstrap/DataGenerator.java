...
public class DataGenerator implements CommandLineRunner {
    ...
    public Account a1 = new Account("Josie D Story", "262  Lochmere Lane", "United States", "Kentucky", "LOUISVILLE", 35, "40289", UserRole.USER);
    public Account a2 = new Account("Bernard P Fendley", "2903  Jarvis Street", "United States", "New York", "Buffalo", 28, "14211", UserRole.USER);
    public Account a3 = new Account("Faith R Parsons", "4161  Alfred Drive", "United States", "New York", "Brooklyn", 47, "11226", UserRole.USER);
    public Account a4 = new Account("Johnnie J Cannon", "2587  Logan Lane", "United States", "New York", "HOLTSVILLE", 47, "00544", UserRole.USER);
    public Account a5 = new Account("Lawrence E Folkerts", "698  Clark Street", "United States", "New York", "Brentwood", 47, "11717", UserRole.USER);

    public Location l1 = new Location("AMC Empire 25",null,null, "10036","United States","New York", "New York","234 W 42nd St") ;
    public Location l2 = new Location("AMC 34th Street 14",null,null, "10001", "United States", "New York", "New York","312 W 34th St");
    public Location l3 = new Location("AMC Lincoln Square 13",null,null, "10023", "United States", "New York", "New York", "1998 Broadway");
    public Location l4 = new Location("AMC Village 7",null,null, "10003", "United States", "New York", "New York", "66 3rd Ave");

    public Genre g1 = new Genre("Comedy");
    public Genre g2 = new Genre("Sci-Fi");
    public Genre g3 = new Genre("Action");
    public Genre g4 = new Genre("Horror");
    public Genre g5 = new Genre("Thriller");
    public Genre g6 = new Genre("Drama");
    public Genre g7 = new Genre("Mystery");
    public Genre g8 = new Genre("Crime");
    public Genre g9 = new Genre("Animation");
    public Genre g10 = new Genre("Adventure");
    public Genre g11 = new Genre("History");
    public Genre g12 = new Genre("Fantasy");
    public Genre g13 = new Genre("Biography");

    public Ticket t1 = new Ticket(15, 14, LocalDateTime.of(2020,12,5,20,00));
    public Ticket t2 = new Ticket(7, 18, LocalDateTime.of(2020,12,5,20,00));
    public Ticket t3 = new Ticket(9, 9, LocalDateTime.of(2020,12,5,20,00));
    public Ticket t4 = new Ticket(18, 12, LocalDateTime.of(2020,12,5,20,00));
    public Ticket t5 = new Ticket(5, 11, LocalDateTime.of(2020,12,5,20,00));
    public Ticket t6 = new Ticket(15, 14, LocalDateTime.of(2020,12,6,20,45));
    public Ticket t7 = new Ticket(7, 18, LocalDateTime.of(2020,12,6,20,45));
    public Ticket t8 = new Ticket(9, 9, LocalDateTime.of(2020,12,6,20,45));
    public Ticket t9 = new Ticket(18, 12, LocalDateTime.of(2020,12,6,20,45));
    public Ticket t10 = new Ticket(5, 11, LocalDateTime.of(2020,12,6,20,45));
    public Ticket t11 = new Ticket(15, 14, LocalDateTime.of(2020,12,7,21,30));
    public Ticket t12 = new Ticket(7, 18, LocalDateTime.of(2020,12,7,21,30));
    public Ticket t13 = new Ticket(9, 9, LocalDateTime.of(2020,12,7,21,30));
    public Ticket t14 = new Ticket(18, 12, LocalDateTime.of(2020,12,7,21,30));
    public Ticket t15 = new Ticket(5, 11, LocalDateTime.of(2020,12,7,21,30));
    public Ticket t16 = new Ticket(15, 14, LocalDateTime.of(2020,12,8,19,00));
    public Ticket t17 = new Ticket(7, 18, LocalDateTime.of(2020,12,8,19,00));
    public Ticket t18 = new Ticket(9, 9, LocalDateTime.of(2020,12,8,19,00));
    public Ticket t19 = new Ticket(18, 12, LocalDateTime.of(2020,12,8,19,00));
    public Ticket t20 = new Ticket(5, 11, LocalDateTime.of(2020,12,8,19,00));
